...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    _safeInit(() {
      _bitacoraRefTempPersistente =
          prefs.getString('ff_bitacoraRefTempPersistente') ??
              _bitacoraRefTempPersistente;
    });
    _safeInit(() {
      _visitas = prefs
  ...
  String? _bitacoraRefTempPersistente;
  String? get bitacoraRefTempPersistente => _bitacoraRefTempPersistente;
  set bitacoraRefTempPersistente(String? value) {
    _bitacoraRefTempPersistente = value;
    value != null
        ? prefs.setString('ff_bitacoraRefTempPersistente', value)
