      ...
      child: AuthUserStreamWidget(
        builder: (context) => StreamBuilder<List<InstitucionesRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            List<InstitucionesRecord> sideNav02InstitucionesRecordList =
                snapshot.data!;
            // Return an empty Container when the item does not exist.
            if (snapshot.data!.isEmpty) {
              return Container();
            }
            final sideNav02InstitucionesRecord =
                sideNav02InstitucionesRecordList.isNotEmpty
                    ? sideNav02InstitucionesRecordList.first
                    : null;
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        valueOrDefault<bool>(
                                    currentUserDocument?.estado, false) ==
                                true
                            ? 'Activo'
                            : 'Inactivo',
