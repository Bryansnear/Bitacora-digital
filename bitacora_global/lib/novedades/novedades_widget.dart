                  ...
                  child: Builder(
                    builder: (context) {
                      if (widget.cajeros ?? false) {
                        // VISTA CAJEROS (ATM) - Desde JSONB Bitacora
                        return StreamBuilder<Bitacora?>(
                          stream: BitacoraService().streamBitacora(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (bitacora == null)
                              return Center(
                                  child: Text("Bitácora no encontrada"));

                            final listaATM = bitacora.listaAtm;
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, listaATMIndex) {
                                final listaATMItem = listaATM[
                                    listaATMIndex]; // Map<String, dynamic>
                                return Padding(
                        ...
                        // VISTA NOVEDADES - Desde Tabla Novedades
                        return StreamBuilder<List<Novedad>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final listaNovedades = snapshot.data!;
