...
class _RegistroWidgetState extends State<RegistroWidget>
  ...
  void initState() {
    ...
    _model.pertenenciasTextController ??= TextEditingController();
    _model.pertenenciasFocusNode ??= FocusNode();
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            24.0, 4.0, 0.0, 0.0),
                                        child: Text(
                                          'Lleno los siguientes datos de la visita',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                font: GoogleFonts.newsreader(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                            ...
                                                            if (selectedMedia !=
                                                                ...
                                                                selectedMedia.every((m) =>
                                                                    validateFileFormat(
                                                                        ...
                                                                        context))) {
                                                              safeSetState(() =>
                                                                  _model.isDataUploading_uploadDataR6g =
                                                                      true);
                                                              ...
                                                              if (selectedUploadedFiles
                                                                ...
                                                                safeSetState(
                                                                    () {
                                                                  _model.uploadedLocalFile_uploadDataR6g =
                                                                      selectedUploadedFiles
                                                                          .first;
                                                                });
                                                              } else {
                                              ...
                                              Padding(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .pertenenciasTextController,
                                                  focusNode: _model
                                                      .pertenenciasFocusNode,
                                                  autofocus: true,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelText: 'Pertenencias',
                                                    labelStyle:
                                                        FlutterFlowTheme.of(
                                                                context)
                                                            .labelMedium
                                                  ...
                                                  cursorColor:
                                                      FlutterFlowTheme.of(
                                                          ...
                                                          .primary,
                                                  validator: _model
                                                      .pertenenciasTextControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                              Padding(
                                                  ...
                                                  children: [
                                                    ...
                                                    Align(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          if ((_model
                                                                      .uploadedLocalFile_uploadDataR6g
                                                                      .bytes
                                                                      ?.isNotEmpty ??
                                                                  false)) {
                                                            {
                                                              safeSetState(() =>
                                                                  _model.isDataUploading_uploadDataR7g =
                                                                      true);
                                                              var selectedUploadedFiles =
                                                                  <FFUploadedFile>[];
                                                              var selectedMedia =
                                                              ...
                                                              if (selectedUploadedFiles
                                                                ...
                                                                safeSetState(
                                                                    () {
                                                                  _model.uploadedLocalFile_uploadDataR7g =
                                                                      selectedUploadedFiles
                                                                          .first;
                                                                    ...
                                                                    getVisitasFirestoreData(
                                                                      createVisitasStruct(
                                                                        ...
                                                                        foto: valueOrDefault<
                                                                            String>(
                                                                          _model
                                                                              .uploadedFileUrl_uploadDataR7g,
                                                                          'https://firebasestorage.googleapis.com/v0/b/bitacoraglobaldigital.appspot.com/o/assets%2Fregistros%2Fvisita.png?alt=media&token=b946bbc6-cf0f-4937-840d-913361ffe1f7',
                                                                        ),
                                                                        cedula: _model
                                                                            .cedulaTextController
                                                                            .text,
                                                              ...
                                                              ...mapToFirestore(
                                                                {
                                                                  'proveedores':
                                                                      FieldValue
                                                                          .arrayUnion([
                                                                    getProveedoresFirestoreData(
                                                                      createProveedoresStruct(
                                                                        nombre: _model
                                                                            .yourNameTextController
                                                                            .text,
                                                                        motivo: _model
                                                              ...
                                                              ...mapToFirestore(
                                                                {
                                                                  'vehiculos':
                                                                      FieldValue
                                                                          .arrayUnion([
                                                                    getVehiculosFirestoreData(
                                                                      createVehiculosStruct(
                                                                        placa: _model
                                                                            .placaTextController
                                                                            .text,
                                                                        motivo: _model
