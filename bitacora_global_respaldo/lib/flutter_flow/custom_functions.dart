...
DocumentReference separarReferenciasHijas(DocumentReference referenciaUnida) {
  // create a function that receives as a parameter a reference which is in this format "2USO3JIAGvKubtHRxSxO|oaGUWcbJXgErbiSa2a9L" and separates it to this "oaGUWcbJXgErbiSa2a9L" eliminating this "2USO3JIAGvKubtHRxSxO" whose separator is this "|"
  final String referenciaCompleta = referenciaUnida.path;
  final String referenciaSeparada = referenciaCompleta.split('|')[1];
  final DocumentReference referenciaHija =
      FirebaseFirestore.instance.doc(referenciaSeparada);
  return referenciaHija;
}
